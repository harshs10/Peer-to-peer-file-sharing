...
public class Client {
	...
	public static ArrayList<Integer> list = new ArrayList<Integer>();//Array of chunk No's.
	
	private static int cPort; //Client Port No.	
	public static Boolean UNflag = true; //Flag whether Upload Neighbour need this client.
     ...
     * Recieve it's share of chunks sent by the FileServer.
     */
	void run(){
		try{
	...
	/*
     * UploadHandler Class Extends Thread. 
     * Send the Chunk No list to Upload Neighbour.
	 * And Receive the Request list of Upload Neighbour.
	 * Send chunks to Upload Neighbour according to its Request list.
	 * Update the UNflag.
     */
	...
	/*
     * DownloadHandler Class Extends Thread. 
	 * Receive the Chunk No list of Download Neighbour.
	 * Send the Reqiest list to Download Neighbour.
	...
	private static class DownloadHandler extends Thread {
		...
		//Compare Download neighbour list with present list and generate Request list
	...
	/*
     * MergeChunks Method. 
	 * Merge all the chunks into single file.
     */
	...
	/*
     * BootStrapHandler Class Extends Thread. 
	 * Send cPort and get N(Download Neighbour Port No.).
     */
	private static class BootStrapHandler{
		...
		public void run() {
			try{
				Socket rs = new Socket("localhost", BSport);
